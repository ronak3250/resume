...
class ContactSave extends StatefulWidget {
  const ContactSave({Key? key}) : super(key: key);
            ...
            InkWell(
                onTap: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    setState(() {
                      userdata.addEntries([
                         MapEntry('image', imagePath),

                        MapEntry('firstname', firstController.text),
                        MapEntry('Secondname', lastController.text),
                        MapEntry('phone', phoneController.text),
                        MapEntry('email', emailControler.text),
                      ]);
                      // "image":"",
                      // "firstname":firstController.text,
                      // "Secondname":lastController.text,
                      // "phone":phoneController.text,
                      // "email":emailControler.text,
                      contactdata.add(userdata);
